...
# 畫出文字雲
# 儲存文字雲圖片
png("Yao_Jan.png", width = 400, height = 400)
...
# 畫出文字雲
# 儲存文字雲圖片
png("Yao_Feb.png", width = 400, height = 400)
...
# 畫出文字雲
# 儲存文字雲圖片
png("Yao_Mar.png", width = 400, height = 400)
...
# 畫出文字雲
# 儲存文字雲圖片
png("Yao_May.png", width = 400, height = 400)
...
# ==== 報導量
Yao_textNum <- rbind(nrow(data_1),nrow(data_2),nrow(data_3),nrow(data_4),nrow(data_5) )
