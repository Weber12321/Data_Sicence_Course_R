...
# 畫出文字雲
# 儲存文字雲圖片
png("Ko_May.png", width = 400, height = 400)
...
# ==== 報導量
Ko_textNum <- rbind(nrow(data_1),nrow(data_2),nrow(data_3),nrow(data_4),nrow(data_5) )
Ko_textNum <- Ko_textNum %>% as.data.frame()
