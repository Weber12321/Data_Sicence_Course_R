...
csg.mean <- sum(course.student.grade)/csn
...
# Check csg.over.mean
csg.over.80.mean <- sum(csg.over.80)/length(csg.over.80)
...
print(paste("人數:", csn))
print(paste("平均:", csg.mean))
print(paste("最高:", csg.max))
print(paste("最低:", csg.min))
